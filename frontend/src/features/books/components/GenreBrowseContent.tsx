...
import { BookBrowseResultItem } from '@/features/books/components/BookBrowseResultItem';
import { BookListSkeleton } from '@/features/books/components/BookListSkeleton';
...
export default function GenreBrowseContent() {
  ...
  return (
    <div className={`page-container ${styles.container}`}>
      ...
      {loading ? <BookListSkeleton loadingMessage="Loading books..." /> : null}
